...
struct LocalKeychain: Keychain {
    func value(account: String) -> String? { nil }
    func setValue(_ value: String, account: String) -> OSStatus { errSecSuccess }
    func remove(account: String) -> OSStatus { errSecSuccess }
}
